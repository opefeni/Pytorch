...
def calculates_results_stats(results_dic):
    ...
    for key,_ in results_dic.items():
        ...
        # number of correctly classified dog or not images
    ...
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img']) * 100 #percentage of correctly classified dogs
    ...
    results_stats_dic['pct_correct_notdogs'] =  (results_stats_dic['n_correct_notdogs'] / results_stats_dic['n_notdogs_img']) * 100 # percentage of correctly classified NON-dogs        
